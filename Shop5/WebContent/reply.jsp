	...
	<section class="bgwhite p-t-60">
		<div class="container">
			<div class="row">
				...
				<form action="replyAction.jsp?&bbsCategories=qa&bbsId=<%=bbsId %>" method="post">
					<table class="table table-striped" style="text-align: center; 1px solid #dddddd">
						<thead>
							<tr>
								<th colspan="2" style="background-color: #eeeeee; text-align: center;">답글</th>
							</tr>
						</thead>
						<tbody>
							<tr>
								<td>
									<input type="text" class="form-control" name="bbsTitle" maxlength="50" value="[RE] <%=bbsTitle %>">
								</td>
							</tr>
							<tr>
					...
					<button type="button" class="btn btn-secondary pull-right" data-toggle="modal" data-target="#exampleModalCenter">등록</button>
 						...
 						<div class="modal-dialog modal-dialog-centered" role="document">
  							<div class="modal-content">
      							<div class="modal-header">
        							<h5 class="modal-title" id="exampleModalCenterTitle">답글 등록</h5>
