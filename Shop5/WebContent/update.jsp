      ...
      <div class="container-menu-header">
         ...
         <div class="wrap_header">
            ...
            <div class="header-icons">
               <a href="mypage.html" class="header-wrapicon1 dis-block">
   ...
   <section class="bgwhite p-t-60">
      <div class="container">
         <div class="row">
            ...
            <form method="post" action="updateAction.jsp?bbsId=<%=bbsId %>&bbsCategories=<%=bbsCategoires %>">
               <table class="table table-striped" style="text-align: center; 1px solid #dddddd">
                  ...
                  <tbody>
                     <tr>
                        <td>
                           <input type="text" class="form-control" placeholder="글 제목" name="bbsTitle" maxlength="50" value="<%=dto.getBbsTitle() %>">
                        </td>
                     </tr>
                     <tr>
                        <td><textarea id="ir1" name="bbsContent" maxlength="2048" style="height: 350px; width: 841px;"><%=dto.getBbsContent() %></textarea></td>
                     </tr>
                  </tbody>      
               </table>
               <!-- Button trigger modal -->
               <button type="button" class="btn btn-secondary pull-right" data-toggle="modal" data-target="#exampleModalCenter">수정</button>
                       ...
                       <div class="modal-content">
                           ...
                           <div class="modal-footer">
                             <button type="button" class="btn btn-secondary" data-dismiss="modal">취소</button>
                               <input type="submit" id="save" value="수정하기" class="btn btn-primary">
                          </div>
                      </div>
                    </div>
               </div>
