	...
	<div class="container">
		<div class="row">
			...
			<div class="col-md-8 col-lg-9 p-b-75">
				<form method="post" enctype="multipart/form-data" action="product-update2.jsp">
								...
								<td>
									<table>
										...
										<tr>
											...
											<td width="800" colspan="7"><input type="text" value="<%=dto.getPId() %>"
												class="form-control" name="pId" maxlength="50" readonly></td>
										</tr>
										<tr>
											<td width="50"><h5 class="m-text16">NAME</h5></td>
											<td width="800" colspan="7"><input type="text" value="<%=dto.getName() %>"
												class="form-control" name="name" maxlength="50"></td>
										</tr>
										<tr>
											<td width="50"><h5 class="m-text16">Explanation</h5></td>
											<td width="800" colspan="7"><input type="text" value="<%=dto.getExplanation() %>"
												class="form-control" name="explanation" maxlength="50"></td>
										</tr>
										<tr>
											<td width="50"><h5 class="m-text16">Price</h5></td>
											<td width="800" colspan="7"><input type="text" value="<%=dto.getPrice() %>"
