	...
	<div class="container">
		<div class="row">
			...
			<div class="col-md-8 col-lg-9 p-b-75">
				<form action="product-update1.jsp?pId=<%=pId%>">
					<table class="table table-striped"
						style="text-align: center; 1px solid #dddddd">
						<thead>
							<tr>
								<th colspan="2"
									style="background-color: #eeeeee; text-align: center;">상품정보</th>
							</tr>
						</thead>
						<tbody>
							<tr>
									...
									<table>
															...
															<div class="block2">
																<div
																	...
																	<table>
																		<tr>
																			<td width="300"><img
																				src="images/clothes/<%=pId %>_1.jpg" alt="IMG-PRODUCT"
																				height="300" /></td>
																			<td width="300"><img
																				src="images/clothes/<%=pId %>_2.jpg" alt="IMG-PRODUCT"
																				height="300" /></td>
																			<td width="300"><img
																				src="images/clothes/<%=pId %>_3.jpg" alt="IMG-PRODUCT"
																				height="300" /></td>
																		</tr>
																	</table>
																	...
																	<div class="block2-overlay trans-0-4">
																		...
																		<div class="block2-btn-addcart w-size1 trans-0-4">
																			...
																			<button
																				...
																				type="button"
																				onclick="javascript:location.href='admin-product-m.jsp?pId=<%=pId%>'">
																				상품 이미지 변경</button>
																		</div>
										...
										<tr>
											...
											<td width="800" colspan="7"><input type="text"
												value="<%=dto.getPId() %>" class="form-control" name="pId"
												maxlength="50" readonly></td>
										</tr>
										<tr>
											<td width="50"><h5 class="m-text16">NAME</h5></td>
											<td width="800" colspan="7"><input type="text"
												value="<%=dto.getName() %>" class="form-control" name="name"
												maxlength="50"></td>
										</tr>
										<tr>
											<td width="50"><h5 class="m-text16">Explanation</h5></td>
											<td width="800" colspan="7"><input type="text"
												value="<%=dto.getExplanation() %>" class="form-control"
												name="explanation" maxlength="50"></td>
										</tr>
										<tr>
											<td width="50"><h5 class="m-text16">Price</h5></td>
											<td width="800" colspan="7"><input type="text"
												value="<%=dto.getPrice() %>" class="form-control"
												name="price" maxlength="50"></td>
										</tr>
										<tr>
											<td width="50"><h5 class="m-text16">SizeS</h5></td>
											<td width="100"><input type="text" class="form-control"
												name="sizeS" maxlength="50" value="<%=dto.getSizeS() %>"></td>
											<td width="50"><h5 class="m-text16">SizeM</h5></td>
											<td width="100"><input type="text" class="form-control"
												name="sizeM" maxlength="50" value="<%=dto.getSizeM() %>"></td>
											<td width="50"><h5 class="m-text16">SizeL</h5></td>
											<td width="100"><input type="text" class="form-control"
												name="sizeL" maxlength="50" value="<%=dto.getSizeL() %>"></td>
											<td width="50"><h5 class="m-text16">SizeXL</h5></td>
											<td width="100"><input type="text" class="form-control"
												name="sizeXL" maxlength="50" value="<%=dto.getSizeXL() %>"></td>
										</tr>
									</table>
								</td>
							</tr>
						...
						<div class="modal-dialog modal-dialog-centered" role="document">
							<div class="modal-content">
								<div class="modal-header">
									<h5 class="modal-title" id="exampleModalCenterTitle">정보 수정</h5>
					...
					<div class="modal fade" id="exampleModalCenter2" tabindex="-1"
						...
						<div class="modal-dialog modal-dialog-centered" role="document">
							<div class="modal-content">
								...
								<div class="modal-footer">
									<button type="button" class="btn btn-secondary"
										data-dismiss="modal" onclick="javascript:location.href='product-del.jsp?pId=<%=pId%>'">삭제</button>
									<button type="button" class="btn btn-secondary"
										data-dismiss="modal">취소</button>
								</div>
							</div>
