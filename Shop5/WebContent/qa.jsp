			...
			<div class="row">
				<div class="col-md-8 col-lg-9 p-b-75">
					...
					<table class="table table-striped" style="text-align: center; 1px solid #dddddd">
						...
						<tbody>
							<%
								...
								ArrayList<BbsDTO> list = dao.qaList(pageNumber);
					...
					<DIV class='aside_menu'>
 						<FORM name='frm' method='post' action='list.jsp?bbsCategories=qa'>
					...
					<div class="pagination flex-m flex-w p-r-50">
						<%	
							if(dao.getNext("qa") == 1) {
								...
								pageNumber = (dao.getNext("qa") - 2) / 10 + 1;
							}
							for(int i=1; i<=pageNumber; i++) {
						%>
								<a href="qa.jsp?pageNumber=<%=i %>" class="item-pagination flex-c-m trans-0-4"><%=i %></a>
						<%
							}
						%>
					</div>
