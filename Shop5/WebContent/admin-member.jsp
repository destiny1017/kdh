				...
				<div style="background: white; width: 900px; height: 800px;">
					...
					<table class="table table-hover">
						...
						<tr onclick="javascript:location.href='#'">
							...
							<td class="s-text13 p-t-5 p-b-5"><%=member.get(i).getId() %></td>											
							<td class="s-text13 p-t-5 p-b-5"><%=member.get(i).getPw() %></td>											
							<td class="s-text13 p-t-5 p-b-5"><%=member.get(i).getName() %></td>											
							<td class="s-text13 p-t-5 p-b-5"><%=member.get(i).getTel() %></td>											
							<td class="s-text13 p-t-5 p-b-5"><%=member.get(i).getAddr() %></td>											
							<%--
							 --%>
						</tr>
						<%} %>
